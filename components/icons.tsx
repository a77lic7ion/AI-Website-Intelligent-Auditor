...
export const ReportsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M15 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8Z"></path><path d="M15 3v4a2 2 0 0 0 2 2h4"></path>
    </svg>
);
...
export const SlackIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12.83 13.17a2.5 2.5 0 0 0-3.66 0 .5.5 0 0 1-.84-.35V9a2.5 2.5 0 0 1 2.5-2.5h.17a2.5 2.5 0 1 1 0 5h-.17a.5.5 0 0 1-.35-.84l1.83-1.83m-1.66 5.33a2.5 2.5 0 0 0 3.66 0 .5.5 0 0 1 .84.35V17a2.5 2.5 0 0 1-2.5 2.5h-.17a2.5 2.5 0 1 1 0-5h.17a.5.5 0 0 1 .35.84L13 16.5m-3.83-1.66a2.5 2.5 0 0 0 0 3.66.5.5 0 0 1 .35.84H7a2.5 2.5 0 0 1-2.5-2.5v-.17a2.5 2.5 0 1 1 5 0v.17a.5.5 0 0 1-.84.35l-1.83-1.83m5.33-1.66a2.5 2.5 0 0 0 0-3.66.5.5 0 0 1-.35-.84H15a2.5 2.5 0 0 1 2.5 2.5v.17a2.5 2.5 0 1 1-5 0v-.17a.5.5 0 0 1 .84-.35l1.83 1.83Z"></path>
    </svg>
);

export const JiraIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12.5 2.5 2.5 12.5l10 10 10-10-2.75-2.75L12.5 17 5.25 9.75Z"></path>
    </svg>
);
