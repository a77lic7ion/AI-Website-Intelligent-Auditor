...
const NewAuditModal: React.FC<NewAuditModalProps> = ({ isOpen, onClose, onStartAudit }) => {
    ...
    return (
        ...
        >
            <div 
                className="bg-white dark:bg-auditor-card w-full max-w-lg rounded-lg shadow-xl relative animate-in-fade"
            ...
            >
                <div className="flex items-start justify-between p-6 border-b border-gray-200 dark:border-auditor-border">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-auditor-text-secondary mt-1">Enter the full URL of the website you want to analyze.</p>
                    </div>
