...
const Header: React.FC<HeaderProps> = ({ title, subtitle, onNewAuditClick }) => {
    return (
        <header className="flex-shrink-0 bg-white dark:bg-auditor-dark border-b border-gray-200 dark:border-auditor-border h-16 flex items-center justify-between px-6 lg:px-8">
            <div>
                ...
                <p className="text-sm text-gray-500 dark:text-auditor-text-secondary truncate max-w-sm md:max-w-md lg:max-w-lg">{subtitle}</p>
            </div>
